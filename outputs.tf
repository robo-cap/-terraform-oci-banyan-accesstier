...
#   value       = oci_core_network_security_group.nsg_nlb.id
#   description = "The ID of the network security group, which can be added as an inbound rule on other backend groups"
# }

# output "nsg" {
#   value       = oci_core_network_security_group.nsg_nlb
#   description = "The `oci_core_network_security_group.nsg_nlb` resource" 
# }
